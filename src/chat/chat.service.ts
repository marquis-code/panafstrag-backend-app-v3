  ...
  async seedDefaultBotConfigs(): Promise<void> {
    ...
    const defaults: Partial<BotConfig>[] = [
      ...
      },
      {
        key: 'faq_about',
        type: 'faq',
        message: 'PANAFSTRAG is the Panafricana Strategic Group dedicated to institutional collaboration, research publications, and strategic growth across Africa.',
